...
const editTimeblock = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const [update] = yield db_config_1.default.execute('UPDATE TimeBlock SET TimeBegin = ?, TimeEnd = ?, Event_ID = ?, Tournament_ID = ?, Building = ?, RoomNumber = ?, Status = ? WHERE TimeBlock_ID = ?', [startTime, endTime, event_id, tournament_id, building, roomNumber, id, status]);
