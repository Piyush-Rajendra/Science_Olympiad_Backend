...
const registerEventSupervisor = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield db_config_1.default.execute('INSERT INTO eventsupervisor (school_group_id, email, username, password, firstName, lastName) VALUES (?, ?, ?, ?, ?, ?)', [
