...
router.get('/get-team-timeblocks-by-timeblock-detailed/:id', teamtimeblock_controller_1.getTeamTimeBlocksByTimeBlockIdDetailed);
...
router.delete('/delete-pdf/:schoolGroup_id', library_controllers_1.deletePDF);
//Resource Library - Q
...
router.put('/questions/:QandA_id/edit', library_controllers_1.editQuestion);
router.get('/questions/bySchool/:schoolGroup_id', library_controllers_1.getQuestionsBySchoolGroupId);
router.get('/questions/:Question/:schoolGroup_id', library_controllers_1.getQandAByQuestionAndSchoolGroupId);
////Resource Library - A
router.put('/questions/:QandA_id/answer', library_controllers_1.addAnswer);
router.put('/questions/:QandA_id/edit-answer', library_controllers_1.editAnswer);
router.get('/questions/schoolGroup/:schoolGroup_id/answered', library_controllers_1.getAnswersBySchoolGroupId);
router.get('/questions/:QandA_id/answer', library_controllers_1.getAnswerByQandAId);
router.put('/questions/edit-questions/:id', library_controllers_1.editQA);
//Excel
