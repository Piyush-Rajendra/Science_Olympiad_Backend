...
router.get('/get-admins-by-groupId/:id', extractJWT_1.authenticateJWT, auth_controllers_1.getAdminsByGroupId);
router.get('/eventsupervisor-by-groupId/:id', extractJWT_1.authenticateJWT, auth_controllers_1.getEventSupervisorsByGroupId);
// Get By Id
